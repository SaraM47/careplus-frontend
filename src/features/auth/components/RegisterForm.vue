<template>
  <form class="space-y-6" @submit.prevent="onSubmit" novalidate aria-labelledby="tab-signup">
    <!-- Email -->
    <div>
      <label for="signup-email" class="block text-lg font-medium mb-2"> Email </label>
    ...
    <!-- Password -->
    <div>
      <label for="signup-password" class="block text-lg font-medium mb-2"> Password </label>
    ...
    <p
      v-if="auth.error"
      class="text-red-700 text-sm bg-red-50 border border-red-200 rounded-lg px-4 py-2"
      role="alert"
    >
      {{ auth.error }}
    </p>
