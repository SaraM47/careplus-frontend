<template>
    ...
    >
      <!-- Email -->
      <div>
        <label for="login-email" class="block text-lg font-medium mb-2">
          Email
        </label>
      ...
      <!-- Password -->
      <div>
        <label for="login-password" class="block text-lg font-medium mb-2">
          Password
        </label>
        ...
        <div class="relative">
          <input
            ...
            :aria-describedby="errors.password ? 'login-password-error' : (auth.error ? 'login-error' : undefined)"
